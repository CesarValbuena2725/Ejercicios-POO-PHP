        ...
        $html = <<<EOT
            <div class="container-fluid well">
                <div class="row clearfix">
                    <form role="form" class="form-horizontal" action="../ControladorPhp/liquidar_empleado.php" method="GET">
                        ...
                        extras</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="valor_extras" id="horas_extras" placeholder="valor extras...">
                            </div>
                            </div>
                                <div class="form-group">
